...
const Men = () => {
 ...
 <>
      ...
      >
        <SwiperSlide>
            <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Web-Banner_3_2.jpg?format=webp&w=1440&dpr=1.3" alt="img1" />
        </SwiperSlide>
        
        <SwiperSlide>
            <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Web-Banner_1_BafR0gz.jpg?format=webp&w=1440&dpr=1.3" alt="img2" />
        </SwiperSlide>
     
        <SwiperSlide>
            <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Web-Banner_Pftjct7.jpg?format=webp&w=1440&dpr=1.3" alt="img3" />
        </SwiperSlide>

        <SwiperSlide>
            <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Terrific_T-shirt-Homepage-Banner_copy.jpg?format=webp&w=1440&dpr=1.3" alt="img4" />
        </SwiperSlide>
      ...
      >
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Colllection-Tiles---Members_final_GbQLUQB.jpg?format=webp&w=480&dpr=1.3" alt="img1" />
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Collection-tile-jogger.jpg?format=webp&w=480&dpr=1.3" alt="img2"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Collection-Tile3-Naruto.jpg?format=webp&w=480&dpr=1.3" alt="img3"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Oversized-FL-Collection-tile.jpg?format=webp&w=480&dpr=1.3" alt="img4"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Hoodies-and-Jackets2-black.jpg?format=webp&w=480&dpr=1.3" alt="img5"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-shirt-Collection-Tiles_red.jpg?format=webp&w=480&dpr=1.3" alt="img6"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/New-Arrivals-Collection-Tiles_Red.jpg?format=webp&w=480&dpr=1.3" alt="img7"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Colllection-Tiles-1-hardik-red.jpg?format=webp&w=480&dpr=1.3" alt="img8"/>
        </SwiperSlide>
        <SwiperSlide>
          <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-Best-Seller.jpg?format=webp&w=480&dpr=1.3" alt="img9"/>
        </SwiperSlide>
      </Swiper>
      <div style={{fontSize:"27px",fontWeight:"700",fontFamily:"sans-serif",textAlign:"center",paddingTop:"25px",paddingBottom:"25px",color:"#282C3F"}}>
        <h1>CATEGORIES</h1>
      ...
      <div className="grided">
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-Website-tile-big-one3.jpg?format=webp&w=480&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-Website-tile-big-one2.jpg?format=webp&w=480&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-Website-tile-big-one1.jpg?format=webp&w=480&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version7.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version4.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/Men-Website-tile-big-one3.jpg?format=webp&w=480&dpr=1.3" alt="" /></div>
      </div>
      <div className="flexx">
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version9.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version2.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version1.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
        <div><img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/product-images/WebsiteTiles_Small_Tushar_men-version3_1.jpg?format=webp&w=360&dpr=1.3" alt="" /></div>
      </div>
      <div style={{fontSize:"27px",fontWeight:"700",fontFamily:"sans-serif",textAlign:"center",paddingTop:"25px",paddingBottom:"25px",color:"#282C3F"}}>
      ...
      <div style={{width:"100%",height:"100%",paddingLeft:"10px",paddingRight:"10px"}}>
        <img src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage_Banner_hardik_1.jpg?format=webp&w=1440&dpr=1.3" alt="" />
      </div>
      <div style={{fontSize:"27px",fontWeight:"700",fontFamily:"sans-serif",textAlign:"center",paddingTop:"25px",paddingBottom:"25px",color:"#282C3F"}}>
        <h1>MEMBERSHIP</h1>
      </div>
